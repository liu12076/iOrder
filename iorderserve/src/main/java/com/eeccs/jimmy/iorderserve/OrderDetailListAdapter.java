...
public class OrderDetailListAdapter extends BaseAdapter {
    private final static String TAG = OrderDetailListAdapter.class.getSimpleName();
    /**
     ...
     * be fine
     */
    private List<OrderDetailItem> mData;
     ...
     * @param mData
     */
    public OrderDetailListAdapter(final Context context, final List<OrderDetailItem> mData) {
        this.mData = mData;
        this.mContext = context;
    }

    public List<OrderDetailItem> getData() {
        return mData;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.list_order_detail_item, parent, false);
            Log.d(TAG, String.format("Get view %d", position));
            // we'll set up the ViewHolder
            viewHolder.good     = (TextView) view.findViewById(R.id.text_good);
            viewHolder.amount      = (TextView) view.findViewById(R.id.text_amount);
        ...
        OrderDetailItem obj = mData.get(position);

        // assign values if the object is not null
        if (mData != null) {
            viewHolder.good.setText(obj.getGood());
            viewHolder.amount.setText(obj.getAmount());
        }
        return view;
    }
